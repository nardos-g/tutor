...
function ce(e, t = {}) {
  ...
  for (let r = 0; r < e.length; r++) {
    let { pressure: i } = e[r],
      { point: o, vector: s, distance: W, runningLength: I } = e[r]
    ...
    ;(O = a(o, oe)),
      (r <= 1 || A(z, O) > te) && (_.push(O), (z = O)),
      (E = l(o, oe)),
      (r <= 1 || A(F, E) > te) && (M.push(E), (F = E)),
      (H = i),
      (X = s)
  }
...
function me(e, t = {}) {
  var q
  let { streamline: u = 0.5, size: x = 16, last: h = !1 } = t
